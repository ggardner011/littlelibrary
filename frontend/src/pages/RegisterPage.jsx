...
function RegisterPage() {
  ...
  const { success, loading, error, message } = useSelector(state => state.auth)
              ...
              <div className="card-body">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="name" placeholder="Enter name" value={name} onChange={(event) => setName(event.target.value)} />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <input type="password" className="form-control" id="password2" placeholder="Password" value={password2} onChange={(event) => setPassword2(event.target.value)} />
                  </div>
